...
/**
  ...
  @param placeholderPtr Pointer to the memory location (that is local variable
    of the subroutine) where return address will be preserved.
...
/**
  ...
  @param placeholderPtr Pointer to the memory location (that is local variable
    of the subroutine) from where return address will be restored.
...
/**
  ...
  @param value Byte value of the parameter for subroutine
...
/**
  ...
  @param value Word value of the parameter for subroutine
...
/**
  ...
  @params ptr Pointer to the byte value of the parameter for subroutine
...
/**
  ...
  @params ptr Pointer to the two bytes value of the parameter for subroutine
...
/**
  ...
  @params placeholderPtr Pointer to the memory location where given byte
    will be pulled to
...
/**
  ...
  @params placeholderPtr Pointer to the beginning of memory location where
...
/**
  Pulls two bytes value from the stack and stores it under provided addresses.
    ...
    @params placeholderPtrList List of memory locations, where given two
